...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Recuperando Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusInstall'] = 'Instalando Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpgrade'] = 'Atualizando para Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Detectado Blockchain-Ads Adserver%s';
