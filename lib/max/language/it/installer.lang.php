...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Ripristino di Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusInstall'] = 'Installazione di Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpgrade'] = 'Aggiornamento a Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Rilevato Blockchain-Ads Adserver%s';
