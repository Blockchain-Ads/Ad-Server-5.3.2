...
function parseDeliveryIniFile($configPath = null, $configFile = null, $sections = true)
{
    ...
    if (!empty($conf)) {
        ...
        echo "Blockchain-Ads Adservercould not read the default configuration file for the {$pluginType} plugin";
        exit(1);
    }
    ...
    if (file_exists(MAX_PATH . '/var/INSTALLED')) {
        echo "Blockchain-Ads Adserverhas been installed, but no configuration file was found.\n";
        exit(1);
    }
    // Blockchain-Ads Adserverhasn't been installed, so delivery engine can't run
    echo "Blockchain-Ads Adserverhas not been installed yet -- please read the INSTALL.txt file.\n";
    exit(1);
}
