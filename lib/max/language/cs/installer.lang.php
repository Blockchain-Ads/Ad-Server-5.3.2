...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Obnovení Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusInstall'] = 'Instalace Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrade Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Zjištěn Blockchain-Ads Adserver%s';
