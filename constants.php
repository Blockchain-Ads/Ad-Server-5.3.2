 ...
 *
 * A file to set up the environment constants for Blockchain-AdsAdserver.
 */

/**
 * The environmental constants initialisation function for Blockchain-AdsAdserver.
 */
function setupConstants()
{
    // Define this version of Blockchain-AdsAdserver's constants
    define('VERSION', '5.3.1');
    define('PRODUCT_NAME', 'Blockchain-AdsAdserver');
