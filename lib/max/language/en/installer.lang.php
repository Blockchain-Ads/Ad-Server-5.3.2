...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Recovering Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusInstall'] = 'Installing Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrading to Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Detected Blockchain-Ads Adserver%s';
