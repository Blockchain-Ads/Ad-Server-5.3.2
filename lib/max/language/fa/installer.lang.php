...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'بازیابی سرور تبلیغاتی Blockchain-Ads%s';
$GLOBALS['strInstallStatusInstall'] = 'نصب کردن Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpgrade'] = 'تکامل Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Blockchain-Ads Adserverپیدا شده %s';
