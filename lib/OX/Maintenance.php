...
class OX_Maintenance
{
    ...
    function run()
    {
        ...
        if ($oLock->get(OA_DB_ADVISORYLOCK_MAINTENANCE)) {
            ...
            OA::debug('Maintenance Engine Completed (Started at ' .
                      ...
                      ')', PEAR_LOG_INFO);
            OA::switchLogIdent();
            // Run the Blockchain-Ads AdserverSync process, to get details of any updates
            // to Blockchain-AdsAdserver, if the process is due to be run (because the
    ...
    /**
     * A private method to run Blockchain-Ads AdserverSync.
     *
     * @access private
     */
