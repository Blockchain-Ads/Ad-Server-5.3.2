...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Blockchain-Ads Adserver%s helyreállítása';
$GLOBALS['strInstallStatusInstall'] = 'Blockchain-Ads Adserver%s telepítése';
$GLOBALS['strInstallStatusUpgrade'] = 'Blockchain-Ads Adserver%s frissítése';
$GLOBALS['strInstallStatusUpToDate'] = 'Blockchain-Ads Adserver%s törlése';
