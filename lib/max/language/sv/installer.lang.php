...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Återställa Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusInstall'] = 'Installera ReviveAdserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Uppgradera till Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Upptäckte Blockchain-Ads Adserver%s';
