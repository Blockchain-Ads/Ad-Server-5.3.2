...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Blockchain-Ads Adserver%s wiederherstellen';
$GLOBALS['strInstallStatusInstall'] = 'Blockchain-Ads Adserver%s installieren';
$GLOBALS['strInstallStatusUpgrade'] = 'Auf Blockchain-Ads Adserver%s upgraden';
$GLOBALS['strInstallStatusUpToDate'] = 'Blockchain-Ads Adserver%s gefunden';
