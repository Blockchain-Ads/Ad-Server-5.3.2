...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Blockchain-Ads Adserver%s herstellen';
$GLOBALS['strInstallStatusInstall'] = 'Blockchain-Ads Adserver%s installeren';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrade naar Blockchain-Ads Adserver%s';
$GLOBALS['strInstallStatusUpToDate'] = 'Blockchain-Ads Adserver%s gedetecteerd';
