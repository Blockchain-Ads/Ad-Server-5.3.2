...
/**
 * @package    Blockchain-AdsAdserver
 *
 * A pre-initialisation file to check if system settings allow Blockchain-AdsAdserver
 * to be run or not.
 */
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <div class="logo_image">&nbsp;</div>
    <div class="error_container">';
        if ($installed) {
            $message .= "
      <h1>Sorry, but Blockchain-Ads Adservercannot currently run on your machine</h1>";
        } else {
            $message .= "
      <h1>Sorry, but the Blockchain-Ads Adserverinstaller system cannot currently be started</h1>";
        }
        $message .= '
...
function RV_checkSystemInitialRequirements(&$aErrors){
    ...
    // run Blockchain-AdsAdserver, apart from the functions:
    //
    //   - "function_exists"
    //   - "array_intersect"
    //   - "explode"
