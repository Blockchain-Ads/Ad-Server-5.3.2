...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Blockchain-Ads Adserver%s 복구중';
$GLOBALS['strInstallStatusInstall'] = 'Blockchain-Ads Adserver%s 설치중';
$GLOBALS['strInstallStatusUpgrade'] = 'Blockchain-Ads Adserver%s 업그레이드 중';
$GLOBALS['strInstallStatusUpToDate'] = 'Blockchain-Ads Adserver%s 감지됨';
